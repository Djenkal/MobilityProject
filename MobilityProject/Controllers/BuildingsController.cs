...
namespace MobilityProject.Controllers
{
    public class BuildingsController : Controller
    {
        private readonly MobilityProjectContext _context;

        public BuildingsController(MobilityProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var building = await _context.Building.SingleOrDefaultAsync(m => m.ID == id);
            if (building == null)
            {
                return NotFound();
            }
